...
pa.add_argument('--w_num', type=int, default = None) # the number of components in the width
pa.add_argument('--h_num', type=int, default = None) # the number of components in the height
pa.add_argument('--tr_bat', type=int, default = None) # the batch szie in training phase
...
run.run_model(w_num= ar.w_num, h_num=ar.h_num, sam_size=ar.sam_size, tim_num=ar.tim_num, tr_bat=ar.tr_bat, te_bat=1000, GPU_str=ar.GPU_str, iter_num= 20000, test_once=ar.test_once, da_str=ar.da_str, aug_str= ar.aug_str)
