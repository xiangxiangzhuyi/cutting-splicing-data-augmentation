...
def run_model(w_num, h_num, sam_size,tim_num, tr_bat, te_bat, iter_num, test_once, da_str, GPU_str, aug_str):
    # saving folder
    sa_str = spb.com_mul_str([da_str, sam_size, tim_num, aug_str, w_num, h_num])
    # construct dataset
    da = spda.dataset(w_num, h_num, sam_size, tim_num, tr_bat, te_bat, da_str, aug_str)
